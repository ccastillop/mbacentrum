...
Devise.setup do |config|
  ...
  config.mailer_sender = "robot@mbacentrum.com"
  ...
  # end
  config.facebook_api_key = "1b11b34df5b4b5ccff8a20abfdc10497"
  config.facebook_api_secret = "e85b42fda2d1ccf80fa102c412b30abe"
